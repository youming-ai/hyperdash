import type { FeedTrade } from './feed';

/**
 * Whale discovery from the live trades feed.
 *
 * Single source of truth for every runtime that ranks addresses by live
 * taker/maker notional: `apps/ingest` (live worker) and the deprecated
 * `apps/api-gateway` re-export from here until removal (2026-09-30).
 *
...
export class WhaleDiscovery {
  private readonly feed: TradeSource;
